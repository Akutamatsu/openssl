...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_extrahope512), "extrahope512"},
    {OQS_KEM_CURVEID(NID_kyber512_90s), "kyber512_90s"},
    {OQS_KEM_CURVEID(NID_kyber768_90s), "kyber768_90s"},
    {OQS_KEM_CURVEID(NID_kyber1024_90s), "kyber1024_90s"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p256_frodo976aes), "p256 - frodo976aes hybrid"},
    {OQS_KEM_CURVEID(NID_p256_frodo976shake), "p256 - frodo976shake hybrid"},
    {OQS_KEM_CURVEID(NID_p256_frodo1344aes), "p256 - frodo1344aes hybrid"},
    {OQS_KEM_CURVEID(NID_p256_frodo1344shake), "p256 - frodo1344shake hybrid"},
    {OQS_KEM_CURVEID(NID_p256_extrahope512), "p256 - extrahope512 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_kyber512_90s), "p256 - kyber512_90s hybrid"},
    {OQS_KEM_CURVEID(NID_p256_kyber768_90s), "p256 - kyber768_90s hybrid"},
    {OQS_KEM_CURVEID(NID_p256_kyber1024_90s), "p256 - kyber1024_90s hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sikep434), "p256 - sikep434 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sikep503), "p256 - sikep503 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sikep610), "p256 - sikep610 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_sikep751), "p256 - sikep751 hybrid"},
