...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1225,    /* "oqs_sig_default" */
    1089,    /* "organizationIdentifier" */
     491,    /* "organizationalStatus" */
    1141,    /* "oscca" */
     475,    /* "otherMailbox" */
     876,    /* "owner" */
    1229,    /* "p256_dilithium2" */
    1217,    /* "p256_extrahope512" */
    1215,    /* "p256_frodo1344aes" */
    1216,    /* "p256_frodo1344shake" */
    1211,    /* "p256_frodo640aes" */
    ...
    1235,    /* "p256_picnicl1fs" */
    1241,    /* "p256_qteslapi" */
    1221,    /* "p256_sikep434" */
    1222,    /* "p256_sikep503" */
    1223,    /* "p256_sikep610" */
    1224,    /* "p256_sikep751" */
    1233,    /* "p384_dilithium4" */
    1244,    /* "p384_qteslapiii" */
    ...
    1243,    /* "qteslapiii" */
     ...
     448,    /* "room" */
     463,    /* "roomNumber" */
    1230,    /* "rsa3072_dilithium2" */
    1227,    /* "rsa3072_oqs_sig_default" */
    1239,    /* "rsa3072_picnic2l1fs" */
    1236,    /* "rsa3072_picnicl1fs" */
    1242,    /* "rsa3072_qteslapi" */
       6,    /* "rsaEncryption" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1225,    /* OBJ_oqs_sig_default              1 3 9999 1 1 */
    1226,    /* OBJ_p256_oqs_sig_default         1 3 9999 1 2 */
    1227,    /* OBJ_rsa3072_oqs_sig_default      1 3 9999 1 3 */
    1228,    /* OBJ_dilithium2                   1 3 9999 2 1 */
    1229,    /* OBJ_p256_dilithium2              1 3 9999 2 2 */
    1230,    /* OBJ_rsa3072_dilithium2           1 3 9999 2 3 */
    1231,    /* OBJ_dilithium3                   1 3 9999 2 4 */
    1232,    /* OBJ_dilithium4                   1 3 9999 2 5 */
    1233,    /* OBJ_p384_dilithium4              1 3 9999 2 6 */
    ...
    1234,    /* OBJ_picnicl1fs                   1 3 6 1 4 1 311 89 2 1 1 */
    1235,    /* OBJ_p256_picnicl1fs              1 3 6 1 4 1 311 89 2 1 2 */
    1236,    /* OBJ_rsa3072_picnicl1fs           1 3 6 1 4 1 311 89 2 1 3 */
    1237,    /* OBJ_picnic2l1fs                  1 3 6 1 4 1 311 89 2 1 11 */
    1238,    /* OBJ_p256_picnic2l1fs             1 3 6 1 4 1 311 89 2 1 12 */
    1239,    /* OBJ_rsa3072_picnic2l1fs          1 3 6 1 4 1 311 89 2 1 13 */
    1240,    /* OBJ_qteslapi                     1 3 6 1 4 1 311 89 2 2 10 */
    1241,    /* OBJ_p256_qteslapi                1 3 6 1 4 1 311 89 2 2 11 */
    1242,    /* OBJ_rsa3072_qteslapi             1 3 6 1 4 1 311 89 2 2 12 */
    1243,    /* OBJ_qteslapiii                   1 3 6 1 4 1 311 89 2 2 20 */
    1244,    /* OBJ_p384_qteslapiii              1 3 6 1 4 1 311 89 2 2 21 */
